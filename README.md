...
> The list has been taken to codeberg.org from [KenneyNL](https://github.com/KenneyNL) on GitHub and [@XdanielArt](https://x.com/XdanielArt) on X. The purpose of copying this repo is to save the record and update any information in case the following repo was lost.

> [You may also find the original screenshotted repo here in case it mysteriously gets deleted off the internet. Not likely, but, eh.](https://web.archive.org/web/20250407014806/https://github.com/KenneyNL/Adobe-Alternatives)
...
![xdanielArt's infographic on Adobe Suite alternatives.](https://pbs.twimg.com/media/GPkD9w0W8AA8xjR?format=jpg&name=4096x4096 | width=100 height=100)
